...
void ClapTrap::displayStatus() const {
    std::cout << "\033[25;2m[ClapTrap] \033[0m" << "Status: " << this->_name << " has " << this->_hit_points << " hit points, " << this->_energy_points << " energy points, and " << this->_attack_damage << " attack damage." << std::endl;
};
