...
// ft_isalpha int main() { for (int i = 0; i < 128; i++) { printf("%c - %d\n", i, ft_isalpha(i)); } return 0; }
// ft_isdigit int main() { for (int i = 0; i < 128; i++) { printf("%c - %d\n", i, ft_isdigit(i)); } return 0; }
// ft_isalnum int main() { for (int i = 0; i < 128; i++) { printf("%c - %d\n", i, ft_isalnum(i)); } return 0; }

/*
// isalpha int	main(void) { int c = 0;  for (int i = 0; i < 257; i++) { printf("%d %d %d \n", c, isalpha(c), ft_isalpha(c)); c++; } return (0); }
...
// memset int	main (void){char str1[] = "Hello World ft_memset"; char str2[] = "Hello World memset"; ft_memset (str1, '-', 5); puts (str1); memset (str2, '-', 5); puts (str2); return (0); }
// ft_bzero     int main() { int arr[5] = {1, 2, 3, 4, 5};    printf("Original array:\n");    for (int i = 0; i < 5; ++i) {        printf("%d ", arr[i]);    }    printf("\n"); ft_bzero(arr, 5 * sizeof(int));    printf("Array after custom_bzero:\n");    for (int i = 0; i < 5; ++i) {        printf("%d ", arr[i]);    }    printf("\n");    return 0;}
